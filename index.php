...
<body>
			...
			<div class="header_topw3layouts_bar">
				<div class="container">
						...
						<div class="col-xl-7 col-lg-6 header_agileits_left">
							<ul>
								...
								<li>
									...
									<a href="mailto:info@arisan.com">info@arisan.com</a>
								</li>
							</ul>
						</div>
					...
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						<a class="navbar-brand" href="#">Social Gathering
		...
		<div class="banner-text-agile">
			<div class="container">
				<div class="banner-w3lstexts text-white text-center">
					...
					<br><center><p style="color: white;">Repost by <a style="color: white;" href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a></p></center>
					
					<h4 class="text-uppercase mt-md-3 mt-2 mb-md-4 mb-3">Family Gathering</h4>
					<p class="text-white">Arisan selain untuk finansial juga bisa sebagai tempat untuk silaturahmi. Biasanya peserta arisan berasal dari berbagai kalangan atau tempat yang berbeda. Dengan demikian arisan memberikan manfaat positif untuk saling bersilaturahmi antar peserta arisan.
					</p>
				...
				<div class="col-lg-4 address-grid">
					<div class="row address-info">
						...
						<div class="col-md-9 address-right text-left">
							...
							<p>
								<a href="mailto:example@email.com"> mail 1@arisan.com</a>
							</p>
							<p>
								<a href="mailto:example@email.com"> mail 2@arisan.com</a>
							</p>
						</div>
	...
	<div class="copy_right py-4 text-center">
		<p class="text-white">© 2018 Social Gathering . All rights reserved | Design by
			<a href="http://Latifah Annisa.com/">Latifah Annisa</a>
		</p>
	</div>
	<!-- //copyright -->
